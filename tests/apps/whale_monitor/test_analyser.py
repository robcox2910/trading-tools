...
from .conftest import DEFAULT_ADDRESS, DEFAULT_TIMESTAMP, make_whale_trade

_ADDRESS = DEFAULT_ADDRESS
_BASE_TS = DEFAULT_TIMESTAMP
...
class TestAnalyseTrades:
    ...
    def test_mixed_sides(self) -> None:
        ...
        trades = [
            make_whale_trade(side="BUY", tx_hash="tx_1"),
            make_whale_trade(side="SELL", tx_hash="tx_2"),
            make_whale_trade(side="BUY", tx_hash="tx_3"),
        ]
        analysis = analyse_trades(_ADDRESS, trades)
    ...
    def test_unique_markets(self) -> None:
        ...
        trades = [
            make_whale_trade(condition_id="cond_a", tx_hash="tx_1"),
            make_whale_trade(condition_id="cond_a", tx_hash="tx_2"),
            make_whale_trade(condition_id="cond_b", tx_hash="tx_3"),
        ]
        analysis = analyse_trades(_ADDRESS, trades)
    ...
    def test_outcome_breakdown(self) -> None:
        ...
        trades = [
            make_whale_trade(outcome="Up", tx_hash="tx_1"),
            make_whale_trade(outcome="Up", tx_hash="tx_2"),
            make_whale_trade(outcome="Down", tx_hash="tx_3"),
        ]
        analysis = analyse_trades(_ADDRESS, trades)
    ...
    def test_top_markets(self) -> None:
        ...
        trades = [
            make_whale_trade(title="Market A", tx_hash="tx_1"),
            make_whale_trade(title="Market A", tx_hash="tx_2"),
            make_whale_trade(title="Market B", tx_hash="tx_3"),
        ]
    ...
    def test_hourly_distribution(self) -> None:
        ...
        trades = [make_whale_trade(timestamp=_BASE_TS)]
        analysis = analyse_trades(_ADDRESS, trades)
    ...
    def test_market_breakdown(self) -> None:
        ...
        trades = [
            make_whale_trade(title="BTC Up/Down", tx_hash="tx_1"),
            make_whale_trade(title="BTC Up/Down", tx_hash="tx_2"),
            make_whale_trade(title="ETH Up/Down", tx_hash="tx_3"),
        ]
        analysis = analyse_trades(_ADDRESS, trades)
...
class TestFormatAnalysis:
    ...
    def test_format_with_data(self) -> None:
        ...
        trades = [
            make_whale_trade(side="BUY", tx_hash="tx_1"),
            make_whale_trade(side="SELL", tx_hash="tx_2"),
            make_whale_trade(side="BUY", outcome="Down", tx_hash="tx_3"),
        ]
        analysis = analyse_trades(_ADDRESS, trades)
        result = format_analysis(analysis)
    ...
    def test_format_long_market_title_truncated(self) -> None:
        ...
        long_title = "A" * 60
        trades = [make_whale_trade(title=long_title)]
        analysis = analyse_trades(_ADDRESS, trades)
        result = format_analysis(analysis)
